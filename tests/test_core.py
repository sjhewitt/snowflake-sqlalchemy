...
from snowflake.sqlalchemy import URL, InsertAll, MergeInto, dialect
...
def test_unconditional_insert_all(sql_compiler):
    ...
    insert_all = (
        ...
        .into(
            users1,
            [users1.c.id, users1.c.name, users1.c.fullname],
            [
    ...
    assert (
        ...
        "INTO users1 (id, name, fullname) VALUES (id, name, fullname) "
...
def test_conditional_insert_all(sql_compiler):
    meta = MetaData()
    users1 = Table(
        "users1",
        meta,
